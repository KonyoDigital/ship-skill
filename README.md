...
`verify_package.py` gates the download on **84 checks** — the shape Desktop rejects, the
...
built from. `--self-test` mutates the package and this README **60 ways** and proves the
