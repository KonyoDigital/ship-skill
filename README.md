...
`verify_package.py` gates the download on **86 checks** — the shape Desktop rejects, the
...
built from. `--self-test` mutates the package and this README **62 ways** and proves the
