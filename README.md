...
`verify_package.py` gates the download on **74 checks** — the shape Desktop rejects, the
...
built from. `--self-test` mutates the package and this README **50 ways** and proves the
