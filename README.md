...
`verify_package.py` gates the download on **73 checks** — the shape Desktop rejects, the
...
built from. `--self-test` mutates the package and this README **49 ways** and proves the
