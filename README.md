...
`verify_package.py` gates the download on **81 checks** — the shape Desktop rejects, the
...
built from. `--self-test` mutates the package and this README **57 ways** and proves the
