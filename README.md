...
`verify_package.py` gates the download on **78 checks** — the shape Desktop rejects, the
...
built from. `--self-test` mutates the package and this README **54 ways** and proves the
