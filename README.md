...
`verify_package.py` gates the download on **83 checks** — the shape Desktop rejects, the
...
built from. `--self-test` mutates the package and this README **59 ways** and proves the
